...
def scrape_sp500_data():
    """
    Obtiene tanto los constituyentes actuales del S&P 500 como los cambios históricos
    de Wikipedia.

    Retorna:
        - pd.DataFrame: DataFrame de los constituyentes actuales.
        - pd.DataFrame: DataFrame de los cambios históricos.
        - set: Un conjunto (set) de todos los tickers que alguna vez han estado en el índice.
    """
    try:
        ...
        return df_current, df_changes, all_tickers_ever
